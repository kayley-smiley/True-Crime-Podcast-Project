...
# View of Courts vs View of Police
plot(Effect("avg_Q9.1", lmod_police_fiu), main = "View of Courts Effect Plot",
     xlab = "View of Courts", ylab = "View of Police")

# View of Prosecutors vs View of Police
plot(Effect("avg_Q9.4", lmod_police_fiu), main = "View of Prosecutors Effect Plot",
     xlab = "View of Prosecutors", ylab = "View of Police")

# Feelings for Police*Getting Conceal License vs View of Police
plot(Effect(c("avg_Q8.2","Q4.10_7"), lmod_police_fiu), main = "Police-Conceal Interaction Effect Plot",
     xlab = "Feelings for Police", ylab = "View of Police")

# Political Stance (Socially) vs View of Police
plot(Effect("Q13.5", lmod_police_fiu), main = "Political Opinion Effect Plot",
     xlab = "Political Stance", ylab = "View of Police")
